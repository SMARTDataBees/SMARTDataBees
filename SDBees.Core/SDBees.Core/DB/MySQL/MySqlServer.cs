...
{
    /// <summary>
    /// Class as a wrapper to MySQL server
    /// </summary>
    public class MySqlServer : Server
    {
        ...
        /// </summary>
        public MySqlServer(DB.Generic.ServerConfigItem srcConfig, string password)
            : base("MySQL", "information_schema", srcConfig, password)
        {
        ...
        public override bool GrantServerPrivileges(string loginName, int accessMask, ref Error error)
        {
            ...
            Database mysqlDb = GetDatabase("mysql");
        ...
        {
            return GrantDatabasePrivileges(loginName, "mysql", AccessFlags.SelectRows, ref error);
        }
