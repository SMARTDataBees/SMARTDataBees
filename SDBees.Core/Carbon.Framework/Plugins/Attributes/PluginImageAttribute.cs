...
namespace Carbon.Plugins.Attributes
{
	...
	public sealed class PluginImageAttribute : ToolboxBitmapAttribute 
	{
		...
		/// </summary>
		/// <param name="imageFilename">The name of a file that contains a 16 by 16 bitmap</param>
		public PluginImageAttribute(string imageFilename) : base(imageFilename) {}
		...
		/// </summary>
		/// <param name="t">"A Type whose defining assembly is searched for the bitmap resource"</param>
		public PluginImageAttribute(Type type) : base(type) {}
	}
}
