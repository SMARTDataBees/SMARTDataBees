...
namespace Carbon.Configuration 
{
	...
	public class XmlConfigurationOption : XmlConfigurationElement
	{
		...
		protected string _typeConverterAssemblyQualifiedName;
...
//				_hasChanges = true;
        ...
        /// <summary>
        /// Gets or sets the fully qualified name of the System.Type of the object's TypeConverter, including the name of the assembly from which the System.Type was loaded.
        /// </summary>
        [Description("Gets or sets the fully qualified name of the System.Type of the object's TypeConverter, including the name of the assembly from which the System.Type was loaded.")]
        [Category("Value Properties")]
        public string TypeConverterAssemblyQualifiedName
        {
            get
            {
                if (_isBeingEdited)
                    if (_editableProxy != null)
                        return ((XmlConfigurationOption)_editableProxy).TypeConverterAssemblyQualifiedName;

                return _typeConverterAssemblyQualifiedName;
            }
            set
            {
                if (_isBeingEdited)
                {
                    if (_editableProxy != null)
                    {
                        ((XmlConfigurationOption)_editableProxy).TypeConverterAssemblyQualifiedName = value;
                        return;
                    }
                }

                if (_typeConverterAssemblyQualifiedName == value)
                    return;
