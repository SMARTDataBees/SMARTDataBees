...
namespace Carbon.Configuration
{
	...
	public class XmlConfigurationManagerEventArgs : EventArgs 
	{
		...
		public XmlConfigurationCollection Configurations
		{
			get
			{
	...
	public delegate void XmlConfigurationManagerEventHandler(object sender, XmlConfigurationManagerEventArgs e);
}
