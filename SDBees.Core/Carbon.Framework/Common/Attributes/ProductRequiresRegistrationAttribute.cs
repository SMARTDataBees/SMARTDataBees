...
namespace Carbon.Common.Attributes
{
	...
	public sealed class ProductRequiresRegistrationAttribute : Attribute 
	{
		...
		/// <summary>
		/// Initializes a new instance of the ProductRequiresRegistrationAttribute class.
		/// </summary>
		...
		/// <summary>
		/// Gets the custom attribute of type ProductRequiresRegistrationAttribute from the assembly.
		/// </summary>
		/// <param name="assembly">The assembly to retrieve the attribute from.</param>
		/// <returns></returns>
		public static ProductRequiresRegistrationAttribute FromAssembly(Assembly assembly)
		{
			try
			{
