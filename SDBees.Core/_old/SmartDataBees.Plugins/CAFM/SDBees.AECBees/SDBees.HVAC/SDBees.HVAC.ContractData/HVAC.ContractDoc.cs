...
namespace SDBees.HVAC.ContractData
{
	/// <summary>
  ...
  [PluginName("HVAC ContractData Plugin")]
  [PluginAuthors("Tim Hoffeller")]
  [PluginDescription("Plugin for the hvac Contractdatas")]
  ...
  public class HVACContractData : SDBees.Plugs.TemplateTreenode.TemplateTreenode
  {
    private static HVACContractData _theInstance;

    /// <summary>
    /// Returns the one and only instance.
    /// </summary>
    public static HVACContractData Current
    {
      get
      {
        return _theInstance;
    ...
    protected override void Start(PluginContext context, PluginDescriptorEventArgs e)
    {
      try
      {
        ...
        if (MyDBManager != null)
        {
          ...
          InitTableSchema(ref HVACContractDataBaseData.gTable, database);
        }
      }
      catch (Exception ex)
      {
    ...
    protected override void Stop(PluginContext context, PluginDescriptorEventArgs e)
    {
      ...
      {
          return HVACContractDataBaseData.gTable;
      }

      public override TemplateTreenodeBaseData CreateDataObject()
      {
          return new HVACContractDataBaseData();
      }
  }
}
