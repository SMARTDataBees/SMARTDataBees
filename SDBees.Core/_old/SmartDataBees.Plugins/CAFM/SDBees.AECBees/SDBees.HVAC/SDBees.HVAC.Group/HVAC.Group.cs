...
namespace SDBees.HVAC.Group
{
  ...
  public class HVACGroup : SDBees.Plugs.TemplateTreenode.TemplateTreenode
  {
    private static HVACGroup _theInstance;

    /// <summary>
    /// Returns the one and only instance.
    /// </summary>
    public static HVACGroup Current
    {
      get
      {
        return _theInstance;
    ...
    /// </summary>
    public HVACGroup() : base()
    {
      _theInstance = this;
	  CreateMenuItem.Text = "Create HVAC Group";
	  DeleteMenuItem.Text = "Delete HVAC Group";
	  EditSchemaMenuItem.Text = "Edit HVAC Group Schema";
    }
    ...
    protected override void Start(PluginContext context, PluginDescriptorEventArgs e)
    {
      try
      {
        ...
        if (MyDBManager != null)
        {
          ...
          InitTableSchema(ref HVACGroupBaseData.gTable, database);
        }
      }
      catch (Exception ex)
      {
    ...
    protected override void Stop(PluginContext context, PluginDescriptorEventArgs e)
    {
      ...
      {
          return HVACGroupBaseData.gTable;
      }

      public override TemplateTreenodeBaseData CreateDataObject()
      {
          return new HVACGroupBaseData();
      }
  }
}
