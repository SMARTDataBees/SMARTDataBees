...
namespace SDBees.HVAC.Element
{
  ...
  public class HVACElement : SDBees.Plugs.TemplateTreenode.TemplateTreenode
  {
    private static HVACElement _theInstance;

    /// <summary>
    /// Returns the one and only instance.
    /// </summary>
    public static HVACElement Current
    {
      get
      {
        return _theInstance;
    ...
    /// </summary>
    public HVACElement() : base()
    {
      _theInstance = this;
	  CreateMenuItem.Text = "Create HVAC Element";
	  DeleteMenuItem.Text = "Delete HVAC Element";
	  EditSchemaMenuItem.Text = "Edit HVAC Element Schema";
    }
    ...
    protected override void Start(PluginContext context, PluginDescriptorEventArgs e)
    {
      try
      {
        ...
        if (MyDBManager != null)
        {
          ...
          InitTableSchema(ref HVACElementBaseData.gTable, database);
        }
      }
      catch (Exception ex)
      {
    ...
    protected override void Stop(PluginContext context, PluginDescriptorEventArgs e)
    {
      ...
      {
          return HVACElementBaseData.gTable;
      }

      public override TemplateTreenodeBaseData CreateDataObject()
      {
          return new HVACElementBaseData();
      }
  }
}
