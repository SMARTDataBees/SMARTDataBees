...
namespace SDBees.AEC.Window
{
  ...
  public class AECWindow : SDBees.Plugs.TemplateTreenode.TemplateTreenode
  {
    ...
    /// </summary>
    public AECWindow() : base()
    {
      _theInstance = this;
	  CreateMenuItem.Text = "Create Window";
	  DeleteMenuItem.Text = "Delete Window";
	  EditSchemaMenuItem.Text = "Edit Window Schema";
    }
    ...
    protected override void Start(PluginContext context, PluginDescriptorEventArgs e)
    {
      try
      {
        ...
        if (MyDBManager != null)
        {
          ...
          InitTableSchema(ref AECWindowBaseData.gTable, database);
        }
      }
      catch (Exception ex)
      {
