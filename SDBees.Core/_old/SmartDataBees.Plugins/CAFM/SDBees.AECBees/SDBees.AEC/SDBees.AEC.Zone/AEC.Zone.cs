...
namespace SDBees.AEC.Zone
{
  ...
  public class AECZone : SDBees.Plugs.TemplateTreenode.TemplateTreenode
  {
    ...
    {
      _theInstance = this;
	  CreateMenuItem.Text = "Create Zone";
	  DeleteMenuItem.Text = "Delete Zone";
	  EditSchemaMenuItem.Text = "Edit Zone Schema";
    }
    ...
    protected override void Start(PluginContext context, PluginDescriptorEventArgs e)
    {
      try
      {
        ...
        if (MyDBManager != null)
        {
          ...
          InitTableSchema(ref AECZoneBaseData.gTable, database);
        }
