...
namespace SDBees.AEC.Room
{
  ...
  public class AECRoom : SDBees.Plugs.TemplateTreenode.TemplateTreenode
  {
    ...
    {
      _theInstance = this;
	  CreateMenuItem.Text = "Create Room";
	  DeleteMenuItem.Text = "Delete Room";
	  EditSchemaMenuItem.Text = "Edit Room Schema";
    }
    ...
    protected override void Start(PluginContext context, PluginDescriptorEventArgs e)
    {
      try
      {
        ...
        if (MyDBManager != null)
        {
          ...
          InitTableSchema(ref AECRoomBaseData.gTable, database);
        }
      }
      catch (Exception ex)
      {
