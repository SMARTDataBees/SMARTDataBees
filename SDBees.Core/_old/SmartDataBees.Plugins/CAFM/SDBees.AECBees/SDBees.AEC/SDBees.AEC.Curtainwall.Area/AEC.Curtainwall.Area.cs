...
namespace SDBees.AEC.Curtainwall
{
	/// <summary>
  ...
  public class AECCurtainwallArea : SDBees.Plugs.TemplateTreenode.TemplateTreenode
  {
    ...
    /// </summary>
    public AECCurtainwallArea() : base()
    {
      _theInstance = this;
	  CreateMenuItem.Text = "Create Curtainwall Area";
	  DeleteMenuItem.Text = "Delete Curtainwall Area";
	  EditSchemaMenuItem.Text = "Edit Curtainwall Area Schema";
    }
    ...
    protected override void Start(PluginContext context, PluginDescriptorEventArgs e)
    {
      try
      {
        ...
        if (MyDBManager != null)
        {
          ...
          InitTableSchema(ref AECCurtainwallAreaBaseData.gTable, database);
        }
      }
      catch (Exception ex)
      {
