...
{
    public class AECCurtainwallAreaBaseData : SDBees.Plugs.TemplateTreenode.TemplateTreenodeBaseData
    {
        ...
        public AECCurtainwallAreaBaseData() :
            base("Fassadenfläche", "Fassade", "Allgemein")
        {
            base.Table = gTable;
        }
        ...
        {
            return AECCurtainwallArea.Current;
        }
