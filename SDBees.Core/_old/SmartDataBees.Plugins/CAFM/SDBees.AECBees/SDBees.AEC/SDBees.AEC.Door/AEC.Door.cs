...
namespace SDBees.AEC.Door
{
  ...
  public class AECDoor : SDBees.Plugs.TemplateTreenode.TemplateTreenode
  {
    ...
    {
      _theInstance = this;
	  CreateMenuItem.Text = "Create Door";
	  DeleteMenuItem.Text = "Delete Door";
	  EditSchemaMenuItem.Text = "Edit Door Schema";
    }
    ...
    protected override void Start(PluginContext context, PluginDescriptorEventArgs e)
    {
      try
      {
        ...
        if (MyDBManager != null)
        {
          ...
          InitTableSchema(ref AECDoorBaseData.gTable, database);
        }
      }
      catch (Exception ex)
      {
