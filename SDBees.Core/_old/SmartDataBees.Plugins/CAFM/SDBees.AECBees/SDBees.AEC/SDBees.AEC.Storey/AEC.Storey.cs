...
namespace SDBees.AEC.Storey
{
  ...
  public class AECStorey : SDBees.Plugs.TemplateTreenode.TemplateTreenode
  {
    private static AECStorey _theInstance;

    /// <summary>
    /// Returns the one and only instance.
    /// </summary>
    public static AECStorey Current
    {
      get
      {
        return _theInstance;
    ...
    /// </summary>
    public AECStorey() : base()
    {
      _theInstance = this;
	  CreateMenuItem.Text = "Create Storey";
	  DeleteMenuItem.Text = "Delete Storey";
	  EditSchemaMenuItem.Text = "Edit Storey Schema";
    }
    ...
    protected override void Start(PluginContext context, PluginDescriptorEventArgs e)
    {
      try
      {
        Console.WriteLine("StoreyPlugin starts\n");
        ...
        if (MyDBManager != null)
        {
          ...
          InitTableSchema(ref AECStoreyBaseData.gTable, database);
        }
    ...
    {
      Console.WriteLine("StoreyPlugin stops\n");
    }
      ...
      {
          return AECStoreyBaseData.gTable;
      }

      public override TemplateTreenodeBaseData CreateDataObject()
      {
          return new AECStoreyBaseData();
      }
  }
}
