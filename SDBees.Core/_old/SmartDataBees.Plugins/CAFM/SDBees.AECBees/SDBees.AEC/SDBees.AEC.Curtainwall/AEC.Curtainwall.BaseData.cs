...
{
    public class AECCurtainwallBaseData : SDBees.Plugs.TemplateTreenode.TemplateTreenodeBaseData
    {
        ...
        public AECCurtainwallBaseData() :
            base("Fassadenname", "Fassade", "Allgemein")
        {
            base.Table = gTable;
        }
