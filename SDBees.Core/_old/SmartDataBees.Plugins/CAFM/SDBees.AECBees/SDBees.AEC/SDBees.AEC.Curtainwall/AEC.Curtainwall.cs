...
namespace SDBees.AEC.Curtainwall
{
  ...
  public class AECCurtainwall : SDBees.Plugs.TemplateTreenode.TemplateTreenode
  {
    ...
    /// </summary>
    public AECCurtainwall() : base()
    {
      _theInstance = this;
	  CreateMenuItem.Text = "Create Curtainwall";
	  DeleteMenuItem.Text = "Delete Curtainwall";
	  EditSchemaMenuItem.Text = "Edit Curtainwall Schema";
    }
    ...
    protected override void Start(PluginContext context, PluginDescriptorEventArgs e)
    {
      try
      {
        ...
        if (MyDBManager != null)
        {
          ...
          InitTableSchema(ref AECCurtainwallBaseData.gTable, database);
        }
      }
      catch (Exception ex)
      {
