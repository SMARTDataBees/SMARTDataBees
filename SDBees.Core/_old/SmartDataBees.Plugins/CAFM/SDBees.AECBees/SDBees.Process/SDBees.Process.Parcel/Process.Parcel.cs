...
namespace SDBees.Process.Parcel
{
	/// <summary>
  ...
  [PluginName("Process Parcel Plugin")]
  [PluginAuthors("Tim Hoffeller")]
  [PluginDescription("Plugin for the process parcel")]
  [PluginId("03D4318A-A6E8-4807-A5DD-EF11425DB4A3")]
  ...
  public class ProcessParcel : SDBees.Plugs.TemplateTreenode.TemplateTreenode
  {
    private static ProcessParcel _theInstance;

    /// <summary>
    /// Returns the one and only instance.
    /// </summary>
    public static ProcessParcel Current
    {
      get
      {
        return _theInstance;
    ...
    /// </summary>
    public ProcessParcel() : base()
    {
      _theInstance = this;
	  CreateMenuItem.Text = "Create Process Parcel";
	  DeleteMenuItem.Text = "Delete Process Parcel";
	  EditSchemaMenuItem.Text = "Edit Process Parcel Schema";
    }
    ...
    protected override void Start(PluginContext context, PluginDescriptorEventArgs e)
    {
      try
      {
		  Console.WriteLine("Process Parcel Plugin starts\n");
        ...
        if (MyDBManager != null)
        {
          ...
          InitTableSchema(ref ProcessParcelBaseData.gTable, database);
        }
      }
      catch (Exception ex)
      {
    ...
    {
		Console.WriteLine("Process Parcel Plugin stops\n");
    }
      ...
      {
          return ProcessParcelBaseData.gTable;
      }

      public override TemplateTreenodeBaseData CreateDataObject()
      {
          return new ProcessParcelBaseData();
      }
  }
}
