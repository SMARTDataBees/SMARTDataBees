...
namespace SDBees.Process.Device
{
	/// <summary>
  ...
  [PluginName("Process Device Plugin")]
  [PluginAuthors("Tim Hoffeller")]
  [PluginDescription("Plugin for the process device")]
  [PluginId("86CD2E48-A9C6-4A13-BD85-12E2199D50AD")]
  ...
  public class ProcessDevice : SDBees.Plugs.TemplateTreenode.TemplateTreenode
  {
    private static ProcessDevice _theInstance;

    /// <summary>
    /// Returns the one and only instance.
    /// </summary>
    public static ProcessDevice Current
    {
      get
      {
        return _theInstance;
    ...
    /// </summary>
    public ProcessDevice() : base()
    {
      _theInstance = this;
	  CreateMenuItem.Text = "Create Process device";
	  DeleteMenuItem.Text = "Delete Process device";
	  EditSchemaMenuItem.Text = "Edit Process device Schema";
    }
    ...
    protected override void Start(PluginContext context, PluginDescriptorEventArgs e)
    {
      try
      {
		  Console.WriteLine("Process device Plugin starts\n");
        ...
        if (MyDBManager != null)
        {
          ...
          InitTableSchema(ref ProcessDeviceBaseData.gTable, database);
        }
      }
      catch (Exception ex)
      {
    ...
    {
		Console.WriteLine("Process device Plugin stops\n");
    }
      ...
      {
          return ProcessDeviceBaseData.gTable;
      }

      public override TemplateTreenodeBaseData CreateDataObject()
      {
          return new ProcessDeviceBaseData();
      }
  }
}
