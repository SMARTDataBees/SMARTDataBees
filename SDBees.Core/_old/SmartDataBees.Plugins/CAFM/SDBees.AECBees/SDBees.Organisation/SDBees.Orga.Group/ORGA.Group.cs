...
namespace SDBees.Orga.Group
{
  ...
  [PluginName("ORGA Group Plugin")]
  [PluginAuthors("Tim Hoffeller")]
  [PluginDescription("Plugin for the group")]
  [PluginId("2F0E21B3-C51C-4A67-9431-AE9BA00261D1")]
  ...
  public class OrgaGroup : SDBees.Plugs.TemplateTreenode.TemplateTreenode
  {
    private static OrgaGroup _theInstance;

    /// <summary>
    /// Returns the one and only instance.
    /// </summary>
    public static OrgaGroup Current
    {
      get
      {
        return _theInstance;
    ...
    /// </summary>
    public OrgaGroup() : base()
    {
      _theInstance = this;
	  CreateMenuItem.Text = "Create Group";
	  DeleteMenuItem.Text = "Delete Group";
	  EditSchemaMenuItem.Text = "Edit Group Schema";
    }
    ...
    protected override void Start(PluginContext context, PluginDescriptorEventArgs e)
    {
      try
      {
		  Console.WriteLine("ORGA Group Plugin starts\n");
        ...
        if (MyDBManager != null)
        {
          ...
          InitTableSchema(ref OrgaGroupBaseData.gTable, database);
        }
      }
      catch (Exception ex)
      {
    ...
    {
		Console.WriteLine("ORGA Group Plugin stops\n");
    }
      ...
      {
          return OrgaGroupBaseData.gTable;
      }

      public override TemplateTreenodeBaseData CreateDataObject()
      {
          return new OrgaGroupBaseData();
      }
  }
}
