...
namespace SDBees.General.ContractData
{
	/// <summary>
  ...
  [PluginName("General ContractData Plugin")]
  [PluginAuthors("Tim Hoffeller")]
  [PluginDescription("Plugin for the basic Contractdatas")]
  [PluginId("D910CF9C-8629-4689-A82D-F9F180B5B245")]
  ...
  public class GeneralContractData : SDBees.Plugs.TemplateTreenode.TemplateTreenode
  {
    private static GeneralContractData _theInstance;

    /// <summary>
    /// Returns the one and only instance.
    /// </summary>
    public static GeneralContractData Current
    {
      get
      {
        return _theInstance;
    ...
    /// </summary>
    public GeneralContractData() : base()
    {
      _theInstance = this;
	  CreateMenuItem.Text = "Create Contract Data";
	  DeleteMenuItem.Text = "Delete Contract Data";
	  EditSchemaMenuItem.Text = "Edit Contract Data Schema";
    }
    ...
    protected override void Start(PluginContext context, PluginDescriptorEventArgs e)
    {
      try
      {
        ...
        if (MyDBManager != null)
        {
          ...
          InitTableSchema(ref GeneralContractDataBaseData.gTable, database);
        }
      }
      catch (Exception ex)
      {
    ...
    protected override void Stop(PluginContext context, PluginDescriptorEventArgs e)
    {
      ...
      {
          return GeneralContractDataBaseData.gTable;
      }

      public override TemplateTreenodeBaseData CreateDataObject()
      {
          return new GeneralContractDataBaseData();
      }
  }
}
