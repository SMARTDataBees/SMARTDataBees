...
{
    public class CRMRootBaseData : SDBees.Plugs.TemplateTreenode.TemplateTreenodeBaseData
    {
        ...
        /// </summary>
        public CRMRootBaseData()
            :
            base("Name", "CRM", "Allgemein")
        {
            base.Table = gTable;
        }
