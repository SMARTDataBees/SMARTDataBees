...
namespace SDBees.CRM.Company
{
  ...
  [PluginName("CRM Company Plugin")]
  [PluginAuthors("Michael Kloss")]
  [PluginDescription("Plugin for the CRM company")]
  [PluginId("4425AC81-3E02-4363-8E69-9CC0EC44DE3C")]
  ...
  public class CRMCompany : SDBees.Plugs.TemplateTreenode.TemplateTreenode
  {
    private static CRMCompany _theInstance;

    /// <summary>
    /// Returns the one and only instance.
    /// </summary>
    public static CRMCompany Current
    {
      get
      {
        return _theInstance;
    ...
    {
      _theInstance = this;
	  CreateMenuItem.Text = "Create Company";
	  DeleteMenuItem.Text = "Delete Company";
	  EditSchemaMenuItem.Text = "Edit Company Schema";
    }
    ...
    protected override void Start(PluginContext context, PluginDescriptorEventArgs e)
    {
      try
      {
		  Console.WriteLine("CRM Company Plugin starts\n");
        ...
        if (MyDBManager != null)
        {
          ...
          InitTableSchema(ref CRMCompanyBaseData.gTable, database);
        }
      }
      catch (Exception ex)
      {
    ...
    {
		Console.WriteLine("CRM Company Plugin stops\n");
    }
      ...
      {
          return CRMCompanyBaseData.gTable;
      }

      public override TemplateTreenodeBaseData CreateDataObject()
      {
          return new CRMCompanyBaseData();
      }
  }
}
