...
namespace SDBees.GIS.Country
{
  ...
  [PluginName("GIS Country Plugin")]
  [PluginAuthors("Tim Hoffeller")]
  [PluginDescription("Plugin for the basic country")]
  [PluginId("9D38E24B-3063-4DD8-A11F-50255EE36EBC")]
  ...
  public class GISCountry : SDBees.Plugs.TemplateTreenode.TemplateTreenode
  {
    private static GISCountry _theInstance;

    /// <summary>
    /// Returns the one and only instance.
    /// </summary>
    public static GISCountry Current
    {
      get
      {
        return _theInstance;
    ...
    /// </summary>
    public GISCountry() : base()
    {
      _theInstance = this;
	  CreateMenuItem.Text = "Create Country";
	  DeleteMenuItem.Text = "Delete Country";
	  EditSchemaMenuItem.Text = "Edit Country Schema";
    }
    ...
    protected override void Start(PluginContext context, PluginDescriptorEventArgs e)
    {
      try
      {
        Console.WriteLine("Country Plugin starts\n");
        ...
        if (MyDBManager != null)
        {
          ...
          InitTableSchema(ref GISCountryBaseData.gTable, database);
        }
      }
      catch (Exception ex)
      {
    ...
    {
      Console.WriteLine("Country Plugin stops\n");
    }
      ...
      {
          return GISCountryBaseData.gTable;
      }

      public override TemplateTreenodeBaseData CreateDataObject()
      {
          return new GISCountryBaseData();
      }
  }
}
