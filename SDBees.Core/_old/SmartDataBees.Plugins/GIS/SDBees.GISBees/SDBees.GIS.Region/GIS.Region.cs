...
namespace SDBees.GIS.Region
{
  ...
  [PluginName("GIS Region Plugin")]
  [PluginAuthors("Tim Hoffeller")]
  [PluginDescription("Plugin for the basic region")]
  [PluginId("0301F97A-6AAC-45E3-A5DB-1F7A26B98290")]
  ...
  public class GISRegion : SDBees.Plugs.TemplateTreenode.TemplateTreenode
  {
    private static GISRegion _theInstance;

    /// <summary>
    /// Returns the one and only instance.
    /// </summary>
    public static GISRegion Current
    {
      get
      {
        return _theInstance;
    ...
    /// </summary>
    public GISRegion() : base()
    {
      _theInstance = this;
	  CreateMenuItem.Text = "Create Region";
	  DeleteMenuItem.Text = "Delete Region";
	  EditSchemaMenuItem.Text = "Edit Region Schema";
    }
    ...
    protected override void Start(PluginContext context, PluginDescriptorEventArgs e)
    {
      try
      {
        Console.WriteLine("Region Plugin starts\n");
        ...
        if (MyDBManager != null)
        {
          ...
          InitTableSchema(ref GISRegionBaseData.gTable, database);
        }
      }
      catch (Exception ex)
      {
    ...
    {
      Console.WriteLine("Region Plugin stops\n");
    }
      ...
      {
          return GISRegionBaseData.gTable;
      }

      public override TemplateTreenodeBaseData CreateDataObject()
      {
          return new GISRegionBaseData();
      }
  }
}
